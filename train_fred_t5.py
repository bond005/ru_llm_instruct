...
def main():
    ...
    parser.add_argument('--alg', dest='algorithm', type=str, required=False, choices=['rmsprop', 'adamw', 'sgd'],
                        default='adamw', help='The training algorithm (RMSprop, AdamW, or SGD).')
