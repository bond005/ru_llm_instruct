...
class TestFactRuEval(unittest.TestCase):
    ...
    def test_load_sample_02(self):
        dataset_path = os.path.join(os.path.dirname(__file__), 'testdata')
        dataset_item = 'book_389'
        true_text = ('Судейский комитет ФИФА на своём заседании в Цюрихе (Швейцария) назвал имена 23-х арбитров, '
                     'которые будут обслуживать матчи предстоящего летом этого года чемпионата мира по футболу. '
                     'В число избранных попал и лучший арбитр Россия — Валентин Иванов. 23 арбитра представляют '
                     '23 страны. В последний раз российский судья участвовал в чемпионате мира 1998 года во Франции, '
                     'это был Николай Левников. Полный список арбитров, которые будут обслуживать матчи финальной '
                     'стадии чемпионата мира 2006 года в Германии с 9 июня по 7 июля:\n\nАвстралию представляет '
                     'один арбитр:\n\n• Марк Шилд (Австралия)\n\nАзию представляют два арбитра:\n\n'
                     '• Тору Камикава (Япония) • Шамсул Майдин (Сингапур)\n\nАфрику представляют два арбитра:\n\n'
                     '• Коффи Коджа (Бенин) • Эссам Абд Эль Фатах (Египет)\n\nЕвропу представляют десять арбитров:\n\n'
                     '• Грэм Полл (Англия) • Франк Де Блекере (Бельгия) • Маркус Мерк (Германия) • Кирос Вассарас '
                     '(Греция) • Мануэль Мехуто Гонсалес (Испания) • Массимо Де Сантис (Италия) • Валентин Иванов '
                     '(Россия) • Любош Михел (Словакия) • Эрик Пула (Франция) • Массимо Бузакка (Швейцария)\n\n'
                     'Центральную Америку представляют три арбитра:\n\n• Карлос Батрес (Гватемала) '
                     '• Бенито Арчундия (Мексика) • Петер Прендергаст (Ямайка)\n\nЮжную Америку представляют пять '
                     'арбитров:\n\n• Горацио Элисондо (Аргентина) • Карлос Симон (Бразилия) • Оскар Руис (Колумбия) '
                     '• Карлос Амарилья (Парагвай) • Хорхе Ларрионда (Уругвай)')
        true_entities = {
            'organization': [
                (0, 22)
            ],
